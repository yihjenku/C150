	...
	with open(infile, 'rU') as f:
		...
		for row in reader:
			if i == 0:
				...
				temp['Test'] = 'Twenty Minute'
				TwentyMinData.append(temp)

			i += 1
	writeTwentyMinute(TwentyMinData)

def writeTwentyMinute(TwentyMinData):
	...
	# TwentyMinute.find().sort('Rank',pymongo.DESCENDING)

	for rower in TwentyMinute.find():
		# print rower
